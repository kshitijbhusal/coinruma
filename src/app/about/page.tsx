      ...
      <div className="h-screen min-h-fit px-10  bg-linear-to-t from-fuchsia-200 via-sky-100 to-fuchsia-200 flex flex-col justify-between  ">
        <div className="container px-4 mx-auto">
          ...
          <section className="text-base font-medium">
            ...
            <br />
            <p>
              CoinRuma is designed with you in mind. We're continuously working
              to enhance our AI capabilities and expand our features to bring
              you the most comprehensive and intuitive crypto insights possible.
              Thank you for choosing CoinRuma as your trusted guide in the
